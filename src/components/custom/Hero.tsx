...
function Hero() {
  return (
    <div className="w-full max-w-4xl flex flex-col items-center mx-auto my-28 md:my-40 gap-9 p-6 md:p-0">
      <h1 className="w-full leading-tight text-slate-800 font-extrabold text-center text-4xl  md:text-6xl md:leading-tight">
        Discover your next&nbsp;
